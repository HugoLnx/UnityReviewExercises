...
//     version 1.4.4
//     from Assets/Scenarios/AnimationRigging/AimInputScenario/Input/WizardRawInputTodo.inputactions
//
...
{
    public partial class @WizardRawInputTodo : IInputActionCollection2, IDisposable
    {
        public InputActionAsset asset { get; }
        public @WizardRawInputTodo()
        {
            asset = InputActionAsset.FromJson(@"{
    ""name"": ""WizardRawInputTodo"",
    ""maps"": [
        {
            ""name"": ""Player"",
    ...
    ""controlSchemes"": []
        ...
        {
            private @WizardRawInputTodo m_Wrapper;
            public PlayerActions(@WizardRawInputTodo wrapper) { m_Wrapper = wrapper; }
